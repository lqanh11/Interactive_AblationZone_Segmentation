...
class CanvasImage:
    ...
    def __init__(self, canvas_frame, canvas):
        ...
        self.current_x = 0 ## x image position
        self.current_y = 0 ## y image position
    ...
    def _reset_canvas_offset(self):
        ...
        self.canvas.scan_dragto(int(self.canvas.canvasx(self.current_x)), int(self.canvas.canvasy(self.current_y)), gain=1)
