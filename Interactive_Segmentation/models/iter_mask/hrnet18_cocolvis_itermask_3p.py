from isegm.data.datasets.ms_lesion import MSLesion
from isegm.utils.exp_imports.default import *
MODEL_NAME = 'mslesion_hrnet18'
...
def train(model, cfg, model_cfg):
    ...
    #     epoch_len=5000
    #     )
    # valset = RetinalDataset(
    #     cfg.RETINAL_VAL_PATH,
    #     augmentator=val_augmentator,
    #     min_object_area=5,
    #     points_sampler=points_sampler,
    #     epoch_len=200
    # )
    # trainset = AblationZone(
    #     cfg.ABLATIONZONE_TRAIN_PATH,
    #     augmentator=train_augmentator,
    #     min_object_area=5,
    #     keep_background_prob=0.05,
    #     points_sampler=points_sampler,
